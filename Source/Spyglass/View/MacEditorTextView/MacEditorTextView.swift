...
struct MacEditorTextView: NSViewRepresentable {
    ...
    func updateNSView(_ view: CustomTextView, context: Context) {
        ...
        if let previousHighlight = context.coordinator.previousHighlight {
            view.unhighlight(previousHighlight)
        }
        
        if let highlight = highlight {
            view.scrollRangeToVisible(highlight)
            view.highlight(highlight)
            context.coordinator.previousHighlight = highlight
        }
    }
}
...
extension MacEditorTextView {
    ...
    class Coordinator: NSObject, NSTextViewDelegate {
        ...
        var previousHighlight: NSRange? = nil
...
final class CustomTextView: NSView {
    ...
    func unhighlight(_ range: NSRange) {
